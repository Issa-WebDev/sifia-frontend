...
export const enTranslations = {
  ...
  heroSubtitle:
    "Join the largest international exhibition dedicated to investors and suppliers in Africa",
  ...
  aboutText1:
    "The International Exhibition of African Suppliers and Investors (SIFIA) is the must-attend event for economic players who wish to develop their activities on the African continent.",
  aboutText2:
    "Bringing together local and international exhibitors, SIFIA offers an exceptional exchange and networking platform to create lasting partnerships and access new markets.",
  aboutMission: "Our Mission",
  aboutMissionText:
    "SIFIA's mission is to create a dynamic ecosystem promoting sustainable investments and partnerships in Africa.",
  ...
  aboutHistoryText:
    "The International Exhibition of African Suppliers and Investors was initiated under the high patronage of the African Union to create an essential meeting point for economic players.",
  aboutVisionText:
    "Our vision is to become the essential hub for Pan-African and international economic exchanges, facilitating strategic investments on the continent.",
  aboutObjectivesText:
    "Our objectives are to promote economic exchanges, stimulate investments, and showcase African innovation to international stakeholders.",
  aboutReadyToJoin: "Ready to join SIFIA 2025?",
  aboutJoinText:
    "Join us in Abidjan for this exceptional edition and develop your activities in the African market.",
  ...
  teamSubtitle:
    "Our leaders are passionate about industrial growth and creating sustainable partnerships worldwide.",

  // Team Members
  jeanMarcName: "JEAN MARC EKRESSIN",
  jeanMarcTitle: "President of SIFIA",
  jeanMarcDescription:
    "Jean Marc Ekressin is a strategic leader directing SIFIA, a flagship event connecting African suppliers and investors to stimulate industrial growth and foster sustainable global partnerships.",

  bintaName: "BINTA SARR",
  bintaTitle: "General Commissioner of SIFIA, Senegal",
  bintaDescription:
    "Binta is responsible for coordinating SIFIA activities in Senegal, ensuring connections between suppliers, investors, and local stakeholders to foster investment opportunities and collaboration in Africa.",

  maigaName: "MAÏGA YOUSSOUFA",
  maigaTitle: "General Commissioner of SIFIA, Mali",
  maigaDescription:
    "Maiga Youssoufa facilitates strategic partnerships and industrial development in Mali, playing a key role in connecting local and international stakeholders at SIFIA.",

  nicerineName: "NICERINE BRES",
  nicerineTitle: "General Commissioner of SIFIA, Morocco",
  nicerineDescription:
    "Nicerine Bres is an essential figure in industrial development in Morocco. As General Commissioner of SIFIA, she works to strengthen synergies between Moroccan suppliers, investors, and economic actors, facilitating strategic opportunities and international collaborations.",

  assogbaName: "ASSOGBA MAWOUSSI",
  assogbaTitle: "General Commissioner of SIFIA, Togo",
  assogbaDescription:
    "Assogba Mawoussi is a renowned nutritionist and dietitian, committed to improving health and nutrition in Africa. As SIFIA General Commissioner in Togo, he plays a key role in promoting local and international partnerships while highlighting the importance of nutrition in industrial and economic development.",

  sfarName: "SFAR NEILA",
  sfarTitle: "General Commissioner of SIFIA, Tunisia",
  sfarDescription:
    "Sfar Neila is a dynamic and strategic leader, playing a key role in coordinating SIFIA activities in Tunisia. She works to strengthen ties between suppliers, investors, and Tunisian economic actors, facilitating the emergence of sustainable partnerships and major projects to stimulate industrial development in Africa and beyond.",

  // Business Areas Section
  businessAreasTitle: "Business Sectors",
  businessAreasSubtitle: "Discover the key sectors represented at SIFIA 2025",
  joinSIFIAPrompt:
    "Does your business operate in one of these sectors? Join us at SIFIA 2025!",
  ...
  offerIntroText1:
    "The International Exhibition of African Suppliers and Investors is a major event that brings together key players from the private and public sectors, investors, and suppliers from various fields.",
  offerIntroText2:
    "It aims to promote investment opportunities in Africa, foster partnerships, and stimulate economic development and trade on the continent.",
  ...
  participateText:
    "3,000 economic operators, 8 strategic markets, 1 unmissable meeting: To register, follow our contact details",
